Feature:WalletDeposit
	...
	Scenario: amount is out of limits
		Given in WalletDepositTest, system has one account with mobile number "66443322", name is "Nike Two" and amount is 50000
		When user inputs deposit amount as 50001 for account with mobile number "66443322"
		Then WalletDepositTest system should print "Maximum balance can only be 100000"

	Scenario: WalletDepositValid
		Given in WalletDepositTest, system has one account with mobile number "88776655", name is "Nike Three" and amount is 50000
		When user inputs deposit amount as 1000 for account with mobile number "88776655"
		Then WalletDepositTest system should print "Balance of account 88776655 is 51000"