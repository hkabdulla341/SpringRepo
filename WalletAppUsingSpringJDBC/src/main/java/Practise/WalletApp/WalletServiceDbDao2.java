// using currval to update -- getting error
...
public class WalletServiceDbDao2 implements WalletRepo
{
    ...
    {
	systemInsertWalletDb(acc.getaWallet());
    ...
    private void systemInsertWalletDb(Wallet getaWallet)
    {
	Map<String, Object> paramMap = new HashMap<String, Object>();
